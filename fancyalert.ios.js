...
var TNSFancyAlert = (function () {
    ...
    TNSFancyAlert.showSuccess = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.SUCCESS, title || "Success!", subTitle, closeBtnTitle, duration, width);
    };
    TNSFancyAlert.showError = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.ERROR, title || "Error!", subTitle, closeBtnTitle, duration, width);
    };
    TNSFancyAlert.showNotice = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.NOTICE, title || "Notice", subTitle, closeBtnTitle, duration, width);
    };
    TNSFancyAlert.showWarning = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.WARNING, title || "Warning!", subTitle, closeBtnTitle, duration, width);
    };
    TNSFancyAlert.showInfo = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.INFO, title || "Info", subTitle, closeBtnTitle, duration, width);
    };
    TNSFancyAlert.showEdit = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.EDIT, title || "Edit", subTitle, closeBtnTitle, duration, width);
    };
    TNSFancyAlert.showWaiting = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.WAITING, title || "Waiting...", subTitle, closeBtnTitle, duration || 5, width);
    };
    TNSFancyAlert.showQuestion = function (title, subTitle, closeBtnTitle, duration, width) {
        return TNSFancyAlert.show(TNSFancyAlert.SUPPORTED_TYPES.QUESTION, title || "Waiting...", subTitle, closeBtnTitle || "Dismiss", duration, width);
    };
    ...
    TNSFancyAlert.show = function (type, title, subTitle, closeBtnTitle, duration, width) {
        ...
        alert["show" + type + "SubTitleCloseButtonTitleDuration"](title, subTitle, null, duration || 0);
    ...
    TNSFancyAlert.createAlert = function (width, onClose) {
