...
declare namespace ts {
  ...
  ): ReadonlyArray<JSDocParameterTag> | undefined;
  /**
  ...
  function getAllJSDocTagsOfKind(
    node: Node,
    kind: SyntaxKind
  ): ReadonlyArray<JSDocTag> | undefined;
}
declare namespace ts {
...
declare namespace ts {
  ...
  function createLiteral(
    sourceNode: StringLiteral | NumericLiteral | Identifier
  ): StringLiteral;
...
declare namespace ts {
  ...
  interface LanguageService {
    ...
    getApplicableRefactors(
      fileName: string,
      positionOrRaneg: number | TextRange
...
declare namespace ts.server {
  ...
  class Session implements EventSender {
    ...
    private mapCodeAction(
      { description, changes: unmappedChanges, commands },
      scriptInfo
    );
...
declare namespace ts.server {
  interface InstallPackageOptionsWithProjectRootPath
  ...
  interface ITypingsInstaller {
    isKnownTypesPackageName(name: string): boolean;
    installPackage(
      options: InstallPackageOptionsWithProjectRootPath
    ): Promise<ApplyCodeActionCommandResult>;
...
declare namespace ts.server {
   ...
   */
  function combineProjectOutput<T>(
  ...
  class ProjectService {
    ...
    updateTypingsForProject(
      response: SetTypings | InvalidateCachedTypings
    ): void;
    ...
    private exceededTotalSizeLimitForNonTsFiles<T>(
      name,
      options,
      fileNames,
      propertyReader
    ...
    private addFilesToNonInferredProjectAndUpdateGraph<T>(
      project,
      files,
      propertyReader,
      typeAcquisition
    ...
    private updateNonInferredProject<T>(
      project,
      newUncheckedFiles,
      propertyReader,
      newOptions,
    ...
    openExternalProject(
      proj: protocol.ExternalProject,
      suppressRefreshOfInferredProjects?: boolean
    ): void;
  }
}
